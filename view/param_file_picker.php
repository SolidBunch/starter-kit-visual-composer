<div class="file-picker-fields">
	<input value="<?php echo esc_attr( $data['value'] ); ?>"
			type="text"
	...
	<button type="button"
        ...
        <?php _e( 'Choose', 'starter-kit' ); ?>
    </button>

	<button type="button" class="vc_btn vc_btn-black jsc-input-file-picker-btn-remove">X</button>
